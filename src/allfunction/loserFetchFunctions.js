...
async function fetchChartData(
  ...
  const result = await fetch(
    `${serverUrl}/api/losergetChartData?chain=${chain}&pair=${pair}&baseCurrency=${baseCurrency}&quoteCurrency=${quoteCurrency}&intervalName=${intervalName}&intervalCount=${intervalCount}&from=${from}&to=${to}`
...
async function fetchTokenData(address) {
  return new Promise((resolve, reject) => {
    fetch(`${serverUrl}/api/losergetTokenInfo?address=${address}`)
      .then((response) => response.json())
      .then((result) => {
...
async function fetchRecentTransactions(address) {
  return new Promise((resolve) => {
    fetch(`${serverUrl}/api/losergetDexTrades?address=${address}`)
      .then((response) => response.json())
      .then((result) => {
        resolve(result);
      })
...
async function loserfetchTopTradePairs(chain) {
    const result = await fetch(
      `${serverUrl}/api/losergetTopTrades?chain=${chain}`
    ).then((response) => response.json());
    if (result.code) {
...
async function fetchBalances(chain, address) {
  const result = await fetch(
    `${serverUrl}/api/losergetTokenBalances?chain=${chain}&address=${address}`
  ).then((response) => response.json());
...
async function fetchTokenCreated(chain, address) {
  const result = await fetch(
    `${serverUrl}/api/losergetTokenCreated?chain=${chain}&address=${address}`
  )
    .then((response) => response.json())
    .catch((err) => 0);
...
async function fetchOwnershipTransferred(chain, addresses) {
  ...
  const result = fetch(
    serverUrl + "/api/losergetOwnershipTransferred",
    requestOptions
  )
    .then((response) => response.json())
    .catch((err) => 0);
...
async function loserfetchPriceVariation(chain, addresses) {
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
  ...
  const result = await fetch(
    `${serverUrl}/api/losergetPriceVariation`,
    requestOptions
  )
    .then((response) => response.json())
    .catch(console.log);
...
async function getPairCurrencies(chain, pair) {
  const result = await fetch(
    `${serverUrl}/api/losergetPairCurrencies?chain=${chain}&pair=${pair}`
  ).then((response) => response.json());
...
async function loserupdatePairAction(message, signature) {
...
async function losergetldforpairs(pairAddresses){
  var myHeaders = new Headers();
  myHeaders.append("Content-Type", "application/json");
...
async function losergetLikeStatusByAccount(walletAddress){
